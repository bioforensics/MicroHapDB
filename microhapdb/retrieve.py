...
def by_region(regionstr):
    ...
    264  mh19KK-056  MHDBM-d6ff8635    GRCh38  chr19                               4852124,4852324  2.4143                          ALFRED
    265  mh19CP-007  MHDBM-49dbcc57    GRCh38  chr19                    14310739,14310772,14310780  3.0813                          ALFRED
    266   mh19NH-23  MHDBM-dd72537b    GRCh38  chr19                    22052723,22052774,22052817     NaN  10.1016/j.legalmed.2015.06.003
    267  mh19KK-299  MHDBM-8cbeb11c    GRCh38  chr19  22546697,22546748,22546779,22546810,22546850  3.8989                          ALFRED
    268   mh19AT-47  MHDBM-8f439540    GRCh38  chr19                    22546697,22546748,22546779  1.4537                   ISFG2019:P597
    269  mh19KK-301  MHDBM-2069446a    GRCh38  chr19           50938487,50938502,50938526,50938550  1.8143                          ALFRED
    270  mh19KK-057  MHDBM-eb558c37    GRCh38  chr19                    51654948,51655025,51655062  2.1923                          ALFRED
    >>> by_region('chr18:1-25000000')
                 Name          PermID Reference  Chrom                                          Offsets   AvgAe                        Source
    257  mh18PK-87558  MHDBM-1e5374f1    GRCh38  chr18  1960542,1960557,1960561,1960566,1960582,1960588  2.3650  10.1016/j.fsigen.2018.05.008
    258    mh18CP-005  MHDBM-a85754d3    GRCh38  chr18                  8892864,8892893,8892896,8892907  3.6635                        ALFRED
    259    mh18KK-285  MHDBM-ea520d26    GRCh38  chr18              24557354,24557431,24557447,24557489  2.6580                        ALFRED
    260     mh18AT-38  MHDBM-db09ec41    GRCh38  chr18                       24557431,24557447,24557489  3.1870                 ISFG2019:P597
    '''
...
def by_id(ident):
    ...
    >>> by_id('mh17KK-014')
               Name          PermID Reference  Chrom                  Offsets   AvgAe  Source
    242  mh17KK-014  MHDBM-83a239de    GRCh38  chr17  4497060,4497088,4497096  1.9183  ALFRED
    >>> by_id('SI664726F')
               Name          PermID Reference  Chrom                  Offsets   AvgAe  Source
    242  mh17KK-014  MHDBM-83a239de    GRCh38  chr17  4497060,4497088,4497096  1.9183  ALFRED
    >>> by_id('MHDBM-ea520d26')
               Name          PermID Reference  Chrom                              Offsets  AvgAe  Source
    259  mh18KK-285  MHDBM-ea520d26    GRCh38  chr18  24557354,24557431,24557447,24557489  2.658  ALFRED
    >>> by_id('PJL')
         ID                           Name Source
