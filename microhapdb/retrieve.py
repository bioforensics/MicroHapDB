...
def by_region(regionstr):
    ...
    362  mh19USC-19pB  MHDBM-76427274    GRCh38  chr19  16040864,16040894,16040899,16040921,16040929  3.5107    10.1016/j.fsigen.2019.102213
    363     mh19NH-23  MHDBM-dd72537b    GRCh38  chr19                    22052723,22052774,22052817  1.9380  10.1016/j.legalmed.2015.06.003
    364    mh19KK-299  MHDBM-8cbeb11c    GRCh38  chr19  22546697,22546748,22546779,22546810,22546850  4.1592                          ALFRED
    365     mh19AT-47  MHDBM-8f439540    GRCh38  chr19                    22546697,22546748,22546779  2.4025                   ISFG2019:P597
    366  mh19USC-19qA  MHDBM-f757e745    GRCh38  chr19           33273771,33273785,33273811,33273816  3.3219    10.1016/j.fsigen.2019.102213
    367    mh19KK-301  MHDBM-2069446a    GRCh38  chr19           50938487,50938502,50938526,50938550  1.9707                          ALFRED
    368    mh19KK-057  MHDBM-eb558c37    GRCh38  chr19                    51654948,51655025,51655062  2.3266                          ALFRED
    369  mh19USC-19qB  MHDBM-7b40359b    GRCh38  chr19                    53714387,53714389,53714413  4.0756    10.1016/j.fsigen.2019.102213
    '''
...
def by_id(ident):
    ...
    >>> by_id('mh17KK-014')
               Name          PermID Reference  Chrom                  Offsets   AvgAe  Source
    330  mh17KK-014  MHDBM-83a239de    GRCh38  chr17  4497060,4497088,4497096  2.0215  ALFRED
    >>> by_id('SI664726F')
               Name          PermID Reference  Chrom                  Offsets   AvgAe  Source
    330  mh17KK-014  MHDBM-83a239de    GRCh38  chr17  4497060,4497088,4497096  2.0215  ALFRED
    >>> by_id('MHDBM-ea520d26')
               Name          PermID Reference  Chrom                              Offsets   AvgAe  Source
    351  mh18KK-285  MHDBM-ea520d26    GRCh38  chr18  24557354,24557431,24557447,24557489  2.7524  ALFRED
    >>> by_id('PJL')
         ID                           Name Source
