...
def test_allele_frequencies():
    ...
    684565  mh15CP-003        YRI  A|A|C    0.02893  Byrska-Bishop2022
    684566  mh15CP-003        YRI  A|G|A    0.59091  Byrska-Bishop2022
    684567  mh15CP-003        YRI  A|G|C    0.38017  Byrska-Bishop2022
    684568  mh15CP-003        YRI  A|G|A    0.57400           Kidd2018
    684569  mh15CP-003        YRI  A|G|C    0.39800           Kidd2018
    684570  mh15CP-003        YRI  A|A|C    0.02800           Kidd2018
    684571  mh15CP-003        YRI  C|G|C    0.00000           Kidd2018
    >>> f.query("Marker == 'mh15CP-003' and Allele == 'A|A|C' and Population == 'FIN'")
                Marker Population Allele  Frequency             Source
    684442  mh15CP-003        FIN  A|A|C    0.31818  Byrska-Bishop2022
    684448  mh15CP-003        FIN  A|A|C    0.31800           Kidd2018
    """
    af = microhapdb.frequencies
    assert af.shape == (902905, 5)
